...
const API = {
  ...
  getImportPreviewStatus: (id) => API.get(`/api/feeds/${id}/import-preview-status`),
  previewImport: (id, directory, filenameFormat) => API.post(`/api/feeds/${id}/import-preview`, { directory, filename_format: filenameFormat || null }),
  commitImport:  (id, items, filenameFormat) =>     API.post(`/api/feeds/${id}/import-stage`, { items, filename_format: filenameFormat || null }),
